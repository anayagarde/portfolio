            ...
            <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center w-full h-full px-4'>
                ...
                <div className='z-0 py-16 px-8 flex justify-items-center max-w-xl'>
                    ...
                    <li class="mb-10 ml-8">            
                            ...
                            <p class="mb-4 ml-5 text-base font-normal text-gray-500 dark:text-gray-400">Masters of Science in Computer Science</p>
                            <time class="block mb-2 ml-5 text-sm font-bold leading-none text-gray-700 dark:text-gray-300">Aug 2024 - May 2026</time>
                        </li>               
                        <li class="mb-10 ml-8">            
                            <span class="absolute flex items-center justify-center w-8 h-8 bg-blue-100 rounded-full -left-4 ring-8 ring-white dark:ring-gray-900 dark:bg-slate-300">
                            <GrCloudComputer/>
                            ...
                            <p class="mb-4 ml-5 text-base font-normal text-gray-500 dark:text-gray-400">Bachelor of Technology in Computer Engineering</p>
                        ...
                        <li class="mb-10 ml-8">
                            ...
                            <p class="mb-4 ml-5 text-base font-normal text-gray-500 dark:text-gray-400">Higher Secondary Education - HSC Board</p>
                        ...
                        <li class="ml-8">
                            ...
                            <p class="mb-4 ml-5 text-base font-normal text-gray-500 dark:text-gray-400">Secondary Education - CBSE Board</p>
