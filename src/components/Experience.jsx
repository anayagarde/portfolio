...
const Experience = () => {
  return (
    <div name="experience" className='h-screen w-full bg-gradient-to-b from-slate-300 to-slate-50 dark:bg-gradient-to-b dark:from-slate-900 dark:via-slate-800 dark:to-slate-600'>
                ...
                <div className='z-0 w-full py-16 px-8 flex justify-items-center'>
                    <ol class="relative border-l border-gray-600 dark:border-gray-300">                  
                        <li class="mb-10 ml-6">            
                            ...
                            <h3 class="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white">Deutsche India Private Ltd</h3>
                            <time class="block mb-2 text-sm font-normal leading-none text-gray-700 dark:text-gray-400">Graduate Analyst (July 2022 - July 2023)</time>
                            ...
                            <time class="block mb-2 text-sm font-normal leading-none text-gray-700 dark:text-gray-400">Senior Analyst (July 2023 - Present)</time>
                        ...
                        <li class="mb-10 ml-6">
                            ...
                            <h3 class="mb-1 text-lg font-semibold text-gray-900 dark:text-white">Deutsche India Private Ltd</h3>
                            <time class="block mb-2 text-sm font-normal leading-none text-gray-700 dark:text-gray-400">Technology Intern (May 2021 - July 2021)</time>
                        ...
                        <li class="ml-6">
                            ...
                            <h3 class="mb-1 text-lg font-semibold text-gray-900 dark:text-white">Veritas Technologies</h3>
                            <time class="block mb-2 text-sm font-normal leading-none text-gray-700 dark:text-gray-400">Project Intern (October 21 - June 2022)</time>
