                ...
                <div className='z-0 py-16 px-8 flex justify-items-center max-w-screen-3xl'>
                    <ol class="relative w-full items-center border-l border-gray-600 dark:border-gray-300">                  
                        <li class="mb-10 ml-6">            
                            ...
                            <time class="block ml-3 mb-2 text-sm font-bold leading-none text-gray-700 dark:text-gray-300">Senior Analyst (July 2023 - Present)</time>
                            <p class="mb-4 ml-3 text-base font-normal text-gray-500 dark:text-gray-400">Working as a full stack developer in Corporate Bank Technology division's Working Capital team. Collaborating and working alongside cross-functional teams.</p>
                            ...
                            <p class="mb-4 text-base ml-3 font-normal text-gray-500 dark:text-gray-400">Acquired an understanding of the framework and architecture of project, assisted the team with development changes, high priority production fixes, and was involved in team deliverables and activities. Worked on developing end to end flows using Java, Spring Boot, ReactJS, Axiom, View Action Server, GraphQL, and Oracle. Participated in Mental Health Hackathon and GenAI Global Hackathon. Active participation in volunteering and hosting events.</p>
                        </li>
                        <li class="mb-10 ml-6">
                            <span class="absolute flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full -left-3 ring-8 ring-white dark:ring-gray-900 dark:bg-sky-500">
                        ...
                        <li class="ml-6">
                            ...
                            <p class="text-base ml-3 font-normal text-gray-500 dark:text-gray-400">Worked on B.Tech. Project on Serverless Data Protection in Cloud </p>
